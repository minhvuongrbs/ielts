...
- Question types:
  - Matching Information (Q1–4): match statements to advertisements A–D
  - True / False / Not Given (Q5–9): evaluate statements against the ad information
- Topic: European river cruise tour packages (prices, destinations, inclusions)

## Answer Key
Source: Appendix 1, p159–160 — Practice activity 2.3, Text 1

Matching Information (Q1–4):
| Q | Answer |
|---|--------|
| 1 | B      |
| 2 | C      |
